...
def menu_viagens():
    while True:
        ...
        if opcao == "1":
            ...
            id_viagem = ler_inteiro("ID da viagem a buscar")
            buscar_viagem(id_viagem)
...
def menu_colaboradores():
    while True:
        ...
        print("5. 🔍 Buscar colaborador por ID")
        print("0. ↩️  Voltar ao menu principal")
        opcao = input("\nEscolha uma opção: ").strip()
        ...
        if opcao == "1":
            ...
            id_colaborador = ler_inteiro("ID do colaborador a buscar")
            buscar_colaborador(id_colaborador)
...
def menu_departamentos():
    while True:
        ...
        if opcao == "1":
            ...
            id_departamento = ler_inteiro("ID do departamento a buscar")
            buscar_departamento(id_departamento)
...
def menu_aprovacoes():
    while True:
        ...
        print("5. 🔍 Buscar aprovação por ID")
        print("0. ↩️  Voltar ao menu principal")
        opcao = input("\nEscolha uma opção: ").strip()
        ...
        if opcao == "1":
            ...
            id_aprovacao = ler_inteiro("ID da aprovação a buscar")
            buscar_aprovacao(id_aprovacao)
...
def menu_caronas():
    while True:
        ...
        if opcao == "1":
            ...
            id_carona = ler_inteiro("ID da carona a buscar")
            buscar_carona(id_carona)
...
def menu_despesas():
    while True:
        ...
        if opcao == "1":
            ...
            id_despesa = ler_inteiro("ID da despesa a buscar")
            buscar_despesa(id_despesa)
...
def menu_objetivos():
    while True:
        ...
        print("5. 🔍 Buscar objetivo por ID")
        print("0. ↩️  Voltar ao menu principal")
        opcao = input("\nEscolha uma opção: ").strip()
        ...
        if opcao == "1":
            ...
            id_objetivo = ler_inteiro("ID do objetivo a buscar")
            buscar_objetivo(id_objetivo)
...
def menu_frota():
    while True:
        ...
        if opcao == "1":
            ...
            id_veiculo = ler_inteiro("ID do veículo a buscar")
            buscar_veiculo(id_veiculo)
...
def menu_analise_eficacia():
    while True:
        ...
        if opcao == "1":
            ...
            id_analise = ler_inteiro("ID da análise a buscar")
            buscar_analise_eficacia(id_analise)
